...
// export const EdgeMessages: FC<EdgeMessagesProps> = ({
//   prefix,
//   curve,
//   elapsed,
//   messages,
...
//         position: curve.getPointAt(
//           Math.max(0, Math.min(1, (elapsed - message.frame) / duration))
//         ),
//         color:
//           message.messageKey[0] === "1"
//             ? "#4070f0"
//             : message.messageKey[0] === "2"
//             ? "#f07040"
//             : "#70f040",
//       };
//     });
